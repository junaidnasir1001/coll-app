                    ...
                    <form id="form">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <input type="hidden" name="contactable_id" id="contactable_id" value="{{ old('id', $semester->id) }}">
                            </div>
                            <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#form').on('submit', function (e) {
                ...
                var route = "{{route('semester.update',['semester'=>':semester'])}}";
                route = route.replace(':semester', id);
                $.ajax({
                    type: 'POST',
                    url: route,
