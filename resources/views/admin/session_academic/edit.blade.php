                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="" name="add_session" placeholder="Enter Designation Name"
                                               value="{{ old('add_session', $session_academic->session) }}">
                                    </div>
                                </div>
                                <input type="hidden" name="contactable_id" id="contactable_id" value="{{ old('id', $session_academic->id) }}">
                            </div>
                            <div class="row">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#form').on('submit', function (e) {
                ...
                var route = "{{route('session-academic.update',['session_academic'=>':session_academic'])}}";
                route = route.replace(':session_academic', id);
                $.ajax({
                    type: 'POST',
                    url: route,
